    ...
    data() {
      return {
        ...
        item_json: [
          ...
          text: "<h3>◆&nbsp仕事内容</h3><p>社員30名、アルバイト30名程度の事業会社で社内の保守・運用をしてきました。うちシステム部５名、キャリア４年。</p><h3>◆&nbspできること（システム）</h3><p>リモート環境構築／システム機器購入／社内サーバーの管理／Gmailなどの外部アプリやPC、社内システムの使い方レクチャー・不具合対処</p><h3>◆&nbsp楽しみ</h3><p>「この作業、もっと楽にできないかな？」の解決を楽しみにしています。<br>その為には、社内ほか事業部の情報インプットが大事です。部分最適にならないように気を付けつつ、素早くシステム改善ができることが社内SEの強みだと考えています。</p>"
          },
